...
<div id="wrap" class="container article">
  ...
  <main>
    <div class="content">
      <div class="post-content">
        <h1 class="post-title">Weekend Preview: March 18-20</h1>
        <span class="categories">Weekend Previews</span>
        <span class="post-meta">D1 Baseball Staff - March 16, 2016</span>
        ...
        <ul>
          <li>Fitt on Arizona State’s big test at Oregon State</li>
          <li>Fitt on Miami’s top-10 showdown against Louisville</li>
          <li>Rogers on Michigan’s big weekend at Oklahoma State</li>
          <li>Top 25 in action</li>
        </ul>

        <h3>Fitt: Scrappy Sun Devils Keep Finding A Way</h3>
      ...
      <div class="post-navigation">
        <div class="previous pull-left">
          <a href="#">
            ...
            <div>
              <span class="byline">Previous Article</span>
              <span class="subsection-head">Midweek Short Hops: Tues., March 8</span>
            </div>
          </a>
        </div>
        <div class="next pull-right">
          <a href="#">
            <div>
              <span class="byline">Next Article</span>
              <span class="subsection-head">D1 Baseball Top 25: How They Fared</span>
            </div>
            <span class="arrow">&#9002;</span>
          </a>
        </div>
      ...
      <section class="category-list">
        <p>FILED UNDER COLLEGE BASEBALL, MIAMI, KENDALL ROGERS, AARON FITT, BUENO, FITZ STADLER, ATLANTIC COAST CONFERENCE, ARIZONA, SUN DEVILS</p>
      </section>

      <section class="related">
        <ul class="tabs">
      		<li class="tab-link category current" data-tab="tab-1">Related Articles</li>
      		<li class="tab-link category" data-tab="tab-2">More from this author</li>
      	</ul>

      	<div id="tab-1" class="tab-content current">
          <a href="#">
            <h5>College Prospect Notebook: Week Four</h5> <span>D1 Baseball Staff</span>
          </a>
          <a href="#">
            <h5>D1Baseball Top 25 Rankings: March 14</h5> <span>D1 Baseball Staff</span>
          </a>
          <a href="#">
            <h5>Weekly College Baseball Chat: March 14</h5> <span>Aaron Fitt</span>
          </a>
          <a href="#">
            <h5>Stat Roundup: March 13 Top Performers</h5> <span>Kendall Rogers</span>
          </a>
          <a href="#">
            <h5>Podcast: Rogers, Fitt Talk Week Four</h5> <span>Kendall Rogers</span>
          </a>
          <a href="#">
            <h5>The Weekly Ouch List: March 14</h5> <span>D1 Baseball Staff</span>
          </a>
      	</div>
